var myBot = new BotUI('hello-world');
    ...
    myBot.message.add({ // show a message
      delay: 200,
      content: 'Hello, my name is WeKeZuDao.'
    }).then (function (){
      myBot.message.add({
        delay: 1000,
        loading: true,
      ...
      switch (res.value) {
        ...
        case 'your contacts':
          ...
          delay: 1000,
          loading: true,
          content: `Go ahead, try [my website](http://codexu.site) or <a href="mailto:codexu@foxmail.com">Email me.</a> </br>
                    Here is my [Github address](https://github.com/wintry).`
        });
        break;/*
        case 'your hobbies':
          return myBot.message.add ({
